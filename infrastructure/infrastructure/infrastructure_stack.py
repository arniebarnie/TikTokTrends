...
class InfrastructureStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Create VPC instead of using default
        vpc = ec2.Vpc(self, "TikTokAnalyticsVPC",
            max_azs=2,
        ...
        # Add Glue and Athena permissions to instance role
        instance_role.add_to_policy(iam.PolicyStatement(
            effect=iam.Effect.ALLOW,
            actions=[
                "glue:CreateDatabase",
            ...
            resources=[
                ...
                f"arn:aws:glue:{self.region}:{self.account}:database/tiktok_analysis",
                f"arn:aws:glue:{self.region}:{self.account}:table/tiktok_analysis/*"
            ]
        ))
        ...
        # Create Batch compute environment using default VPC
        ...
        # Create job definition with exact g4dn.xlarge specifications
        ...
        # Add outputs for Glue resources
        ...
        mysql_security_group = ec2.SecurityGroup(self, "MySQLSecurityGroup",
            vpc=vpc,
        ...
        # Output the instance ID and secret ARN
